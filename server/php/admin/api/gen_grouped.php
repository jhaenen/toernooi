...
var_dump($court1_games);
var_dump($court2_games);
...
// Print the length of the priority queues
echo "PQ1: " . $pq_games1->count() . "<br>";
echo "PQ2: " . $pq_games2->count() . "<br>";
...
for ($round = 0; $round < $max_games; $round++) {
    ...
    echo "PQ1: " . $pq_games1->valid() . "<br>";
    echo "PQ2: " . $pq_games2->valid() . "<br>";
    ...
    if ($round < $court1_num) {
        ...
        if ($round < $court2_num) {
            echo "PQ1 after: " . $pq_games1->valid() . "<br>";
            ...
            do {
                ...
                $rejectStack->top()->team1 == $game1?->team1 ||
